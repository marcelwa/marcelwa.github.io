...
* Habilitation Candidate, Technical University of Munich, 2027 (expected graduation)
...
* Since 2025: Contributor and co-maintainer of [QDMI-on-IQM](https://github.com/iqm-finland/QDMI-on-IQM)
  ...
  * Enables the HPCQC integration case study demonstrated on real IQM hardware (cf. the [paper](https://marcelwa.github.io/files/2026_010.pdf))
...
* Executive team for international conferences
  ...
  * Host and organizer of the special session on *Field-coupled Nanocomputing (FCN)* at the [*IEEE International Conference on Nanotechnology* (IEEE NANO) 2024](https://2024.ieeenano.org/special-invited-sessions-2/)
